		...
		<div class="col-lg-12">
			<div class="ibox ">
                ...
                <div class="ibox-tools">
                    <a href="<?= site_url('menu_route_listing') ?>" class="btn btn-w-m btn-success btn-xs" id="customBTN">
                        Route List
                    </a>
                </div>
            </div>
						...
						<div class="col-sm-8 offset-sm-2 b-r">
							...
							<form id="addForm">
								...
								<div class="form-group">
									<label>Label</label>
									<input type="text" required name="name" placeholder="Label" class="form-control">
								</div>
